...
def infer_performance_level(application_type: str, expected_users: int,
                             current_performance: str) -> tuple[str, float]:
    workload = estimate_workload_category(expected_users)
...
def infer_storage_need(application_type: str, expected_users: int,
                        current_storage: int) -> tuple[int, float]:
    workload = estimate_workload_category(expected_users)
    base = {
